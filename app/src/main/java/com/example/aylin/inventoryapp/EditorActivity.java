...
public class EditorActivity extends AppCompatActivity {
    ...
    /** EditText field to enter the supliers' name */
    private EditText mSuplierEditText;

    /** EditText field to enter the supliers' phone*/
    ...
    private void insertItem() {
        ...
        String quantitiyString = mQuantityEditText.getText().toString().trim();
        int price = Integer.parseInt(priceString);
        int suplierphoneString = Integer.parseInt(suplierPhoneString);
        int quantity = Integer.parseInt(quantitiyString);
        ...
        values.put(ItemEntry.COLUMN_SUPLIER_PHONE,suplierphoneString);
