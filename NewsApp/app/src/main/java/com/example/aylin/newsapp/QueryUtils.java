    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Extract the value for the key called "category"
                String properties = currentNews.getString("category");

                String ndate = "No";

                if(currentNews.has(ndate)){
                    ndate = currentNews.getString(ndate);
                }
                ...
                News newsNews = new News(title, category, author, date,url);
